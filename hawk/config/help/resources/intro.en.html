<p>For every service or application that you want to be highly available,
...
any other server-based applications or services.</p>
<p>Before configuring and starting a cluster resource, set up the service
...
sure they are present and identical on all cluster nodes.</p>