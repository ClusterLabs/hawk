...
begin
  ...
  class FCGI
    ...
    # Nasty hack because rack/handler/fastcgi.rb tries to override
    # the read method of FCGI::Stream, which doesn't exist in this
    # implementation (incidentally, this was fixed in rack in Oct 2009 by
    # http://github.com/rack/rack/commit/f22a0818cbc06be23fab1e0246c226af058b56bc
    # but that fix isn't available in rack 1.0.x...)
    class Stream
      def read(n)
      end
    end
...
end # end vendor directory override
